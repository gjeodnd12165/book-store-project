...
export class CartItemService {
  ...
  create(bookId: number, quantity: number, userId: number): Promise<CartItem> {
  ...
  findAll(cartItemIds: number[], userId: number): Promise<CartItem[]> {
  ...
  delete(cartItemId: number, userId: number): Promise<number> {
    return this.sequelize.transaction(async (t: Transaction) => {
